...
def format_screen(value):#format the value to be displayed on the lcd
    ...
    line1 = binary_text + hex_text.rjust(16-len(binary_text))#format the value to be displayed on the lcd
...
def run(stop_event):
    ...
    while not stop_event.is_set():#keep running forver until stopped
