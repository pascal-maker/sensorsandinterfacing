...
Y_CHANNEL = 4#channel of the adc So this function takes the channel number and converts it into the command format the ADC expects.I must translate channel 5 into the exact binary command the ADC understands.
